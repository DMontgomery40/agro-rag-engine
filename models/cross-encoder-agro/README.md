...
pairs = [
    ...
    ['where is langgraph used in agro', '- Secure your proxy with IP allowlists or auth if exposing publicly.\n\n'],
...
* Samples:
  | sentence_0                                                             | sentence_1                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | label            |
  |:-----------------------------------------------------------------------|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:-----------------|
  | <code>where is the code for evals?</code>                              | <code>    alert('Embedding model added.');<br>  }<br><br>  async function addRerankModelFlow(){<br>    const provider = promptStr('Rerank provider (cohere, local, hf)', 'cohere');<br>    if (!provider) return;<br>    let model = promptStr('Rerank model ID (e.g., rerank-3.5 or BAAI/bge-reranker-v2-m3)', provider === 'cohere' ? 'rerank-3.5' : 'BAAI/bge-reranker-v2-m3');<br>    const baseUrl = promptStr('Base URL (optional)', '');<br>    let apiKey = '';<br>    if (provider === 'cohere') apiKey = promptStr('Cohere API Key (optiona</code>    | <code>0.0</code> |
  ...
  | <code>where is langgraph used in agro</code>                           | <code>- Secure your proxy with IP allowlists or auth if exposing publicly.<br><br></code>                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | <code>0.0</code> |
