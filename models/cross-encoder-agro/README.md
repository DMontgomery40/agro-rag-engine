...
* Approximate statistics based on the first 100 samples:
  ...
  | details | <ul><li>min: 27 characters</li><li>mean: 38.95 characters</li><li>max: 59 characters</li></ul> | <ul><li>min: 180 characters</li><li>mean: 476.6 characters</li><li>max: 500 characters</li></ul> | <ul><li>min: 0.0</li><li>mean: 0.2</li><li>max: 1.0</li></ul> |
* Samples:
  | sentence_0                                                               | sentence_1                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | label            |
  |:-------------------------------------------------------------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:-----------------|
  | <code>Where is COLLECTION_NAME used?</code>                              | <code>reset_frequency_tracking():<br>    """Reset all frequency tracking (useful for cleanup)."""<br>    global _call_history, _frequency_summary<br>    _call_history.clear()<br>    _frequency_summary.clear()<br>    logger.info("Frequency tracking reset")<br></code>                                                                                                                                                                                                                                                                                                           | <code>0.0</code> |
  | <code>Where is SentenceTransformer used?</code>                          | <code>reset_frequency_tracking():<br>    """Reset all frequency tracking (useful for cleanup)."""<br>    global _call_history, _frequency_summary<br>    _call_history.clear()<br>    _frequency_summary.clear()<br>    logger.info("Frequency tracking reset")<br></code>                                                                                                                                                                                                                                                                                                           | <code>0.0</code> |
