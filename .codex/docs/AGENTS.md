...
**Key Components**:
- `.claude/docs/CLAUDE.md` - Claude Code configuration (source of truth)
- `.codex/docs/AGENTS.md` - This file (Codex CLI bridge documentation)
...
- **.claude/docs/CLAUDE.md**: Project configuration for Claude Code
...
**Sync Strategy**: One-way sync (.claude/docs/CLAUDE.md → .codex/docs/AGENTS.md)

---

*This AGENTS.md is auto-generated from .claude/docs/CLAUDE.md and project structure.*
*To update, modify .claude/docs/CLAUDE.md and run: `/sync-agents-md` or regenerate with codex-cli-bridge skill.*
