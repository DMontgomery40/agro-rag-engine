    ...
    <div id="tab-profiles" className="tab-content">
      ...
      <div id="tab-profiles-overrides" className="section-subtab">
        <div className="settings-section" style={{ borderLeft: '3px solid var(--accent)' }}>
          ...
          <p className="small">
            HTTP, MCP, and CLI model overrides live under Admin → Integrations. Use the button
            below to jump there.
          </p>
          <button
            className="small-button"
            id="btn-open-admin-integrations"
            style={{ background: 'var(--link)', color: 'var(--accent-contrast)', fontWeight: 600 }}
          >
