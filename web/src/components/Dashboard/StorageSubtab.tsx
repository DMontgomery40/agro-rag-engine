...
export function StorageSubtab() {
  ...
  const loadStorage = async () => {
    ...
    try {
      ...
      setProfileCount(data.profile_count || 0);
      setLoading(false);
    } catch (err) {
        ...
        {loading ? (
          ...
          <>
            ...
            <div style={{ marginBottom: '20px' }}>
              ...
              >
                <span>▶</span>
                <span>INDEX PROFILES ({profileCount})</span>
              </button>
            </div>
      ...
      <div className="settings-section" style={{ background: 'var(--panel)', borderLeft: '3px solid var(--link)' }}>
        ...
        >
          <ul style={{ margin: 0, paddingLeft: '20px', lineHeight: '1.8', fontSize: '13px', color: 'var(--fg)' }}>
            ...
            <li>
              <strong>Cards/Summary:</strong> Pre-computed summaries enable faster retrieval with minimal storage cost
            </li>
            <li>
